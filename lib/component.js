var Component = function(obj) {
  ...
  Component.prototype.$display = function() {
    ...
    if(this.components instanceof Object) {
      for(var componentName in this.components) {
        var display = this.components[componentName].$display;
        if(display instanceof Function) {
          display = display.bind(this.components[componentName]);
          display();
        }
      }
    }
  ...
  Component.prototype.$init = function() {
    ...
    if(this.components instanceof Object) {
      for(var componentName in this.components) {
        var init = this.components[componentName];
        if(init instanceof Function) {
          this.components[componentName] = init(this);
        }
      }
    }
