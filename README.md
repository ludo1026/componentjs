...
**$init** must be called on the parent component which initializes its existing children components, and **$init** must be called on each new sub components added after the initialization of the parent component.
